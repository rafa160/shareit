...
//                             PieChartSectionData(
//                               color: Colors.blue,
//                               value: infoBloc.internetProblems.length
//                                           .toDouble() >=
//                                       1
//                                   ? infoBloc.internetProblems.length.toDouble()
//                                   : 0.0,
...
//                               value: infoBloc.reports.length.toDouble() >= 1
//                                   ? infoBloc.reports.length.toDouble()
//                                   : 0.0,
...
//                               value: infoBloc.others.length.toDouble() >= 1
//                                   ? infoBloc.others.length.toDouble()
//                                   : 0.0,
...
//                               color: Colors.purple,
//                               value:
//                                   infoBloc.phoneProblems.length.toDouble() >= 1
//                                       ? infoBloc.phoneProblems.length.toDouble()
//                                       : 0.0,
...
//                               value:
//                                   infoBloc.softwareIssues.length.toDouble() >= 1
//                                       ? infoBloc.softwareIssues.length
//                                           .toDouble()
//                                       : 0.0,
...
//                             PieChartSectionData(
//                               color: Colors.red,
//                               value: infoBloc.equipmentsIssues.length
//                                           .toDouble() >=
//                                       1
//                                   ? infoBloc.equipmentsIssues.length.toDouble()
//                                   : 0.0,
...
//                             PieChartSectionData(
//                               color: Colors.yellow,
//                               value: infoBloc.login.length.toDouble() >= 1
//                                   ? infoBloc.login.length.toDouble()
//                                   : 0.0,
...
//                             PieChartSectionData(
//                               color: Colors.green,
//                               value: infoBloc.installEquipment.length
//                                           .toDouble() >=
//                                       1
//                                   ? infoBloc.installEquipment.length.toDouble()
//                                   : 0.0,
...
//                             PieChartSectionData(
//                               color: Colors.black,
//                               value: infoBloc.softwareInstall.length
//                                           .toDouble() >=
//                                       1
//                                   ? infoBloc.softwareInstall.length.toDouble()
//                                   : 0.0,
...
//             ),
//             IndicatorWidget(
//               categories: infoBloc.categories,
//             )
//           ],
//         ),
//       ),
